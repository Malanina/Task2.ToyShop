...
public class Menu {
    ...
    public static void menu() {
        ...
        Toy toy1 = new PrizeToy("Кукла Барби", 10, 20);
        Toy toy2 = new PrizeToy("Кукла Таня", 10, 35);
        Toy toy3 = new PrizeToy("Мягкая игрушка Заяц", 10, 50);
        Toy toy4 = new PrizeToy("Мягкая игрушка Мишка", 10, 71);
        Toy toy5 = new PrizeToy("Машинка", 10, 20);
        Toy toy6 = new PrizeToy("Мячик", 10, 45);
        store.addToy(toy1);
        store.addToy(toy2);
        store.addToy(toy3);
        store.addToy(toy4);
